...
private:
    ...
    VkQueue graphicsQueue; // Most likely the same value
    ...
    void createInstance() {
        ...
        if (enableValidationLayers && !layersAvailable) {
    ...
    int rateDeviceSuitability(VkPhysicalDevice device) {
        ...
        // Can check only if swapchain extension is supported
    ...
    void createDescriptorSetLayout() {
        ...
        uboLayoutBinding.stageFlags = VK_SHADER_STAGE_VERTEX;
